		...
		<div class="container">
			<div class="father">
				<div class="front">
					<header>
						<div class="bkg" />
						<img src={LogoPersona} alt="Picture" width="90" height="90" style="border-radius: 50%;"/>
						<h3 style="font-size: 1.4rem;">
							...
							{data.Datos.personalName} {data.Datos.lastname}
						</h3>
					</header>
					<div class="experiences" style="text-align: center;">
						<p style="font-weight: bold; color: #7352F2">
							...
							Universidad Politecnica de Tapachula</p>
					...
					<header>
						...
						<div class="experiences" style="text-align: center;">
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
								...
								{data.Emergency.emergency_phone} {data.Emergency.emergency_phone2}
							</p>
							...
							{#if data.Emergency.allergy != null}
								<p style="color: #1a1423 !important;">
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-lungs" viewBox="0 0 16 16">
