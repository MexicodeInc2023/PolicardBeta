...
<style>
	.card{width:18rem;height:120px;transition:all .5s;box-shadow:15px 15px 30px rgba(25,25,25,0.247),-15px -15px 30px rgba(60,60,60,0.082);text-align:center;overflow:hidden;border:#23c483 3px solid}.card:hover{height:22rem}.card .header{padding:30px 0 10px;margin:-12px;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#feffff}.register{border:#8123c4 3px solid!important}.card .header .login_user{font-size:1.2em;letter-spacing:.1em;font-weight:600;text-transform:uppercase;padding:18px 0 0;transition:all .5s;color:#000}.register_user{font-size:1.2em;letter-spacing:.1em;font-weight:600;text-transform:uppercase;padding:18px 0 0;transition:all .5s;color:#000}.card .content{text-align:center;color:#212121;margin:0 18px}.htxt{font-weight:600;font-size:1.5rem;margin-top:30px;margin-bottom:22spx}.data_reason{padding:1.3em 3em;margin-top:10px;font-size:12px;text-transform:uppercase;letter-spacing:2.5px;font-weight:500;color:#000;background-color:#fff;border:none;border-radius:45px;box-shadow:0 8px 15px rgba(0,0,0,0.1);transition:all .3s ease 0;cursor:pointer;outline:none}.data_correction{padding:1.3em 3em;margin-top:10px;font-size:12px;text-transform:uppercase;letter-spacing:2.5px;font-weight:500;color:#000;background-color:#fff;border:none;border-radius:45px;box-shadow:0 8px 15px rgba(0,0,0,0.1);transition:all .3s ease 0;cursor:pointer;outline:none}.data_reason:hover{background-color:#23c483;color:#fff;transform:translateY(-7px)}.data_correction:hover{background-color:#7352f3;color:#fff;transform:translateY(-7px)}.data_reason:active{transform:translateY(-1px)}.data_correction:active{transform:translateY(-1px)}
</style>
