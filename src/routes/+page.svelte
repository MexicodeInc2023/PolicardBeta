		...
		<div class="container">
			<div class="row main">
				<div class="col-xl-6 col-lg-8">
					...
					<a href="/info" class="btn btn-primary">Más informacion</a>
				</div>
